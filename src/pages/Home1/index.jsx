          ...
          <div className="bg-gray-100 sm:h-[485px] md:h-[721px] h-[879px] pt-8 md:px-5 px-8 relative w-full">
            <div className="flex flex-col md:gap-10 gap-[105px] h-full items-start justify-start m-auto w-[83%]">
              <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start ml-0.5 md:ml-[0] w-full">
                <div className="flex md:flex-1 flex-row font-fredoka gap-2 items-center justify-start w-[17%] md:w-full">
                  <Img
                ...
                <div className="flex md:flex-1 flex-col font-dmsans items-center justify-start md:ml-[0] ml-[52px] md:mt-0 mt-2 w-[5%] md:w-full">
                  <Text
                ...
                <a
                  href="javascript:"
                  className="md:ml-[0] ml-[227px] md:mt-0 mt-2 text-blue_gray-900 text-lg"
                >
                ...
                <div className="flex md:flex-1 flex-row font-dmsans gap-5 items-center justify-between md:ml-[0] ml-[75px] w-[23%] md:w-full">
                  <Img
            ...
            <Img
              ...
              alt="m028t0135amed"
            />
            <div className="absolute flex flex-row gap-1.5 items-start justify-center left-[38%] top-[5%] w-[12%]">
              <Text

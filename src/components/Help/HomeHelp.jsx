    ...
    <div className='help-container-wrapper'>
        <div className='help-container'>
            <div className='self-center'>
                <h4>help</h4>
                <h1 className='my-4'>A <span> Dialysis Patient’s </span> Life Is Hard. Laugh Harder.</h1>
                ...
                >
                    ...
                    <div className='grid1'>
                        {['Name', 'Email', 'Phone number', 'Subject'].map((e) => (
                            <div><input type="text" placeholder={e} /></div>
                        ))}
                    </div>
                    <textarea className=' w-full' name="" id="" cols="30" rows="5" placeholder='Message'></textarea>
                    <button>Submit Request <RightArrow/></button>
                </form>
            </div>
        </div>        
    </div>
